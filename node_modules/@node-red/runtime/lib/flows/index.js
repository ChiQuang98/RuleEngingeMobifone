...
// }
 ...
 function getFlows(req,type) {
    // console.log("QuangLoadFlow: "+JSON.stringify(activeConfig.flows))
    // console.log("INNNKAKA" + req.session.token)
    // if(typeof req.session !== "undefined" || req.session.token === true){}
    ...
    if(type==="loadFlows"){
        ...
        var finalData = JSON.stringify(JSON.parse(res.getBody('utf8')).message);
        console.log("QuangLoadFlow: "+JSON.parse(res.getBody('utf8')).message)
        if(JSON.parse(res.getBody('utf8')).status==1){
            activeConfig.flows = JSON.parse(res.getBody('utf8')).message
            // activeConfig.flows = JSON.parse(res.getBody('utf8')).message.substring(1,finalData.lastIndexOf("")-1)
            // console.log("QUANGKKA: "+finalData.substring(1,finalData.lastIndexOf("")-1))
            // console.log("QuangLoadFlow: "+activeConfig.flows)
        }
        else{
        ...
        console.log("after")
        // activeConfig = JSON.parse(res.getBody('utf8')).message
    }
    return activeConfig
