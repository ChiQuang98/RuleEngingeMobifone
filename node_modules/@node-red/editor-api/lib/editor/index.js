        ...
        if (!started) {
            ...
            if(req.session){
                ...
                if (typeof token !== 'undefined'){
                    ...
                    callback = function(response) {
                        ...
                        response.on('end', function () {
                            ...
                            if (response.statusCode == 200) {
                                ...
                                res.status(401).send("Không thể xác thực!!!")
                            }
                        });
                    }
                    ...
                    //     try {
                    //         const resp = await axios.get("http://"+settingConfig.getHostNodered()+':'+settingConfig.getPortNodered()+settingConfig.getUrlCheckToken(), {
                    //             headers: {
                    //                 'authorization': `${token}`
                    //             }
                    //         });
                    //         console.log("Quangssss")
