...
<!--    </script>-->
    ...
    <script type="text/javascript">
        ...
        var loadData = function () {
            ...
            var apiGetAll = 'http://10.16.150.132:8010/api-gw/v1/thing/getall'
            let data = {
            ...
            fetch(apiUrlLogin, {
                ...
                var authorization = result1.token
                ...
                fetch(apiGetAll, {
                    ...
                    for (var i = 0; i < listChannel.length; i++) {
                        ...
                        el.textContent = listChannel[i].name;
                        el.value = "channels/"+listChannel[i].id+"/messages";    
