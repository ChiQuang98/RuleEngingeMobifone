...
<script type="text/html" data-template-name="mqtt in">
    ...
    <script type="text/javascript">
        ...
        var token = 'Bearer ' + readCookie('TokenUser')
        console.log("TokenQuabg: " + token)
        var loadData = function () {
            // var apiUrlLogin = 'http://10.16.150.132:8010/api-gw/v1/user/login'
            var apiGetAll = 'http://10.16.150.132:8010/api-gw/v1/channel/list-all'
            let data = {
            ...
            fetch(apiGetAll, {
                ...
                a.addEventListener('change', function () {
                    ...
                    setCookie("AUTHENUSER",username+"."+password, 1)
                }, false);
            }).catch(err2 => {
                console.log(err2);
            });
...
<script type="text/html" data-template-name="mqtt out">
    ...
    <script type="text/javascript">
        ...
        var token = readCookie('TokenUser')
        console.log("TokenQuabg: " + token)
        var loadData = function () {

            var apiUrlLogin = 'http://10.16.150.132:8010/api-gw/v1/user/login'
            var apiGetAll = 'http://10.4.201.56:8010/api-gw/v1/channel/list-all'
            let data = {
                "email": "NodeRedUser@mobifone.vn",
                "password": "12345678"
            };
            ...
            fetch(apiGetAll, {
                ...
                //   credentials: 'include',
                // body: JSON.stringify(data),
                headers: {"Content-type": "application/json; charset=UTF-8", Authorization: authen},
            }).then(response => {
                return response.json();
            }).then(result1 => {
                var listChannel = result1.data
                ...
                //     console.log('Done');
                // }
                // document.head.appendChild(select);
            }).catch(err2 => {
                console.log(err2);
            });
        }
                ...
                var tabs = RED.tabs.create({
                    ...
                    onchange: function(tab) {
                        ...
                        if(tab.id == 'mqtt-broker-tab-security'){
                            ...
                            $('#node-config-input-password').val(arrRes[1]);
                        }
                    }
                });
                tabs.addTab({
